...
const SkillLogo = ({ name, active }: { name: string; active: boolean }) => {
  ...
  switch (name) {
    ...
    case 'Java':
      return (
        <svg viewBox="0 0 64 64" className="skill-icon" aria-hidden="true">
          <g transform="translate(8,4) scale(0.82)">
            <path d="M30 8 C28 14 32 16 30 22" stroke="#E76F00" strokeWidth="2.5" strokeLinecap="round" fill="none" opacity="0.85" />
            <path d="M36 5 C34 11 38 13 36 19" stroke="#E76F00" strokeWidth="2.5" strokeLinecap="round" fill="none" opacity="0.7" />
            <path d="M42 9 C40 15 44 17 42 23" stroke="#E76F00" strokeWidth="2" strokeLinecap="round" fill="none" opacity="0.55" />
            <path d="M18 26 L16 46 C16 50 20 54 26 54 L44 54 C50 54 54 50 54 46 L52 26 Z" fill="#5382A1" />
            <rect x="16" y="22" width="38" height="5" rx="2.5" fill="#5382A1" />
            <path d="M52 30 C58 30 62 34 62 38 C62 42 58 46 52 46" stroke="#5382A1" strokeWidth="3.5" fill="none" strokeLinecap="round" />
            <path d="M24 32 L24 48" stroke="rgba(255,255,255,0.12)" strokeWidth="2" strokeLinecap="round" />
            <rect x="20" y="58" width="30" height="3" rx="1.5" fill="#E76F00" />
          </g>
        </svg>
      );
    case 'Dart':
    ...
    case 'MongoDB':
      return (
        <svg viewBox="0 0 64 64" className="h-full w-full" aria-hidden="true">
          <g transform="translate(32,28) scale(1.3) translate(-32,-28)">
    ...
    case 'Canva':
      return (
        <svg viewBox="0 0 64 64" className="skill-icon" aria-hidden="true">
          ...
          <path
            d="M32 8 C18 8 8 18 8 32 C8 46 18 56 32 56 C38 56 43 53.5 46.5 49.5 L38 38 C36.5 40.2 34 41.5 32 41.5 C27.5 41.5 24 37.5 24 33 C24 28.5 27.5 24.5 32 24.5 C34 24.5 35.8 25.3 37 26.5 L45.5 16.5 C41.5 11.5 37 8 32 8Z"
            fill="url(#canva-grad)"
          />
          <path
            d="M46.5 49.5 L52 44 C53.5 43 54.5 41 54.5 39 L46.5 49.5Z"
            fill="url(#canva-grad)"
            opacity="0.7"
          />
        </svg>
