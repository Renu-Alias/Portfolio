...
const SkillLogo = ({ name, active }: { name: string; active: boolean }) => {
  ...
  switch (name) {
    ...
    case 'Java':
      return (
        <svg viewBox="0 0 64 64" className="h-full w-full" fill="none" aria-hidden="true">
          <path d="M28 10c8 5-6 8 2 14" stroke="#E76F00" strokeWidth="3" strokeLinecap="round" opacity={muted} />
          <path d="M37 8c8 6-8 10 1 17" stroke="#E76F00" strokeWidth="3" strokeLinecap="round" opacity={muted} />
